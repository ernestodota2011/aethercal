...
merges second rebases its ``down_revision`` onto the head the first one left. This file names the
parent that exists on ITS branch — ``0008_rls_roles_and_policies`` — and the rebase is mechanical.
The revision ID itself (20 chars) is the reserved one and does not move.

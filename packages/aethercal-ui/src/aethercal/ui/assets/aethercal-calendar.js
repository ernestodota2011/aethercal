...
`;function Je(){if(typeof document>"u"||document.getElementById(fn))return;let e=document.createElement("style");e.id=fn,e.textContent=yn,document.head.appendChild(e)}import*as C from"react";function Ge(e,t){return new Intl.DateTimeFormat(t,{weekday:"short",day:"numeric"}).format(v(e))}function vn(e,t){return new Intl.DateTimeFormat(t,{hour:"numeric"}).format(new Date(2001,0,1,e))}function hn(e,t){if(e.length===0)return"";let n=v(e[0]);if(e.length===1)return new Intl.DateTimeFormat(t,{dateStyle:"full"}).format(n);let a=v(e[e.length-1]),r=new Intl.DateTimeFormat(t,{month:"short",day:"numeric",year:"numeric"});return`${r.format(n)} \u2013 ${r.format(a)}`}var bn="aethercal-timegrid-styles",Dn=`
...
`;function Ht(){if(typeof document>"u"||document.getElementById(bn))return;let e=document.createElement("style");e.id=bn,e.textContent=Dn,document.head.appendChild(e)}import{Fragment as Tn,jsx as Z,jsxs as we}from"react/jsx-runtime";function ut(...e){return e.filter(Boolean).join(" ")}var De=e=>`${e*100}%`,En=new Set;function xn(e){let t=v(e);return t.getHours()*60+t.getMinutes()}function Vt(e,t,n){let a=v(`${e}T00:00:00`),r=new Date(a.getFullYear(),a.getMonth(),a.getDate(),0,t,0);return new Intl.DateTimeFormat(n,{hour:"numeric",minute:"2-digit"}).format(r)}function na(e,t,n,a){let{event:r,isContinuation:i,continuesAfter:s}=e;return i?s?n:a(oe(r.end,t)):oe(r.start,t)}function gt(e,t){let n=t.getBoundingClientRect();return n.height>0?(e-n.top)/n.height:0}function Bt(e){let{view:t,days:n,events:a,locale:r,config:i,now:s,themeVars:g,onEventDrop:c,onEventResize:l,onRangeSelect:h,onEventClick:b,onContextMenu:m,pendingIds:k=En,rolledBackIds:E=En}=e,u=C.useMemo(()=>{if(e.messages)return e.messages;let o={...e.allDayLabel!==void 0?{allDay:e.allDayLabel}:{},...e.continuesLabel!==void 0?{continues:e.continuesLabel}:{},...e.formatEndsLabel!==void 0?{endsAt:e.formatEndsLabel}:{}};return We(r,o)},[e.messages,e.allDayLabel,e.continuesLabel,e.formatEndsLabel,r]);C.useEffect(()=>{Je(),Ht()},[]);let T=C.useMemo(()=>Pt(n,a,i),[n,a,i]),z=C.useMemo(()=>Ot(s,i),[s,i]),G=C.useMemo(()=>re(F(s)),[s]),[H,X]=C.useReducer(xt,et),P=C.useRef(null),[W,I]=C.useState(null),[te,Ae]=C.useState(null),se=!!c,_=!!l,de=!!h,J=H.status==="dragging",U=C.useCallback((o,d)=>p=>{if(p.preventDefault(),H.status!=="dragging"){X({type:"COMMIT"});return}let w=H.eventId,D=p.dataTransfer.getData("text/plain");if(X({type:"COMMIT"}),D&&D!==w||!c)return;let y=a.find(ne=>ne.id===w);if(!y||y.editable===!1)return;let f=null;if(d&&y.allDay!==!0){let ee=p.currentTarget.getBoundingClientRect();ee.height>0&&Number.isFinite(p.clientY)&&(f=Ie((p.clientY-ee.top)/ee.height,T.config))}c(at(y,o,f))},[H,a,c,T.config]),M=C.useCallback(o=>{P.current?.kind!=="resize"&&X({type:"DRAG_START",eventId:o})},[]),q=C.useCallback(()=>X({type:"CANCEL"}),[]),Re=C.useCallback((o,d)=>p=>{if(!l||o.editable===!1||p.button!==0||P.current)return;let w=p.currentTarget.closest(".aethercal-tg-col");w?.dataset.date&&(p.preventDefault(),p.stopPropagation(),P.current={kind:"resize",pointerId:p.pointerId,eventId:o.id,edge:d,dateOnly:w.dataset.date,colEl:w,payload:null},p.currentTarget.setPointerCapture?.(p.pointerId),X({type:"RESIZE_START",eventId:o.id,edge:d}))},[l]),ye=C.useCallback(o=>d=>{if(!h||d.button!==0||P.current||d.target.closest("[data-event-id], button"))return;let p=d.currentTarget,w=Ie(gt(d.clientY,p),T.config);P.current={kind:"select",pointerId:d.pointerId,anchorDate:o,anchorCol:p,anchorMinute:w,currentDate:o,currentCol:p,currentMinute:w},p.setPointerCapture?.(d.pointerId),X({type:"SELECT_START",point:{dateOnly:o,minuteOfDay:w}})},[h,T.config]),le=H.status==="resizing"||H.status==="selecting";C.useLayoutEffect(()=>{if(!le)return;let o=y=>{let f=P.current;if(!(!f||y.pointerId!==f.pointerId))if(f.kind==="resize"){let ne=document.elementFromPoint(y.clientX,y.clientY)?.closest(".aethercal-tg-col"),ee=ne?.dataset.date?ne:f.colEl,Oe=Ie(gt(y.clientY,ee),T.config),$e=a.find(yt=>yt.id===f.eventId);if(!$e)return;let Ee=Be($e,f.edge,ee.dataset.date??f.dateOnly,Oe);f.payload=Ee,I(Ee)}else{let ne=document.elementFromPoint(y.clientX,y.clientY)?.closest(".aethercal-tg-col"),ee=ne?.dataset.date?ne:f.currentCol;f.currentCol=ee,f.currentDate=ee.dataset.date??f.anchorDate,f.currentMinute=Ie(gt(y.clientY,ee),T.config);let Oe=Ue({dateOnly:f.anchorDate,minuteOfDay:f.anchorMinute},{dateOnly:f.currentDate,minuteOfDay:f.currentMinute}),Ee=(f.currentDate===f.anchorDate?Ye([{id:"__sel",title:"",start:Oe.start,end:Oe.end}],f.anchorDate,T.config):[])[0];Ae(Ee?{dateOnly:f.anchorDate,topFraction:Ee.topFraction,heightFraction:Ee.heightFraction}:null)}},d=y=>{let f=P.current;P.current=null,I(null),Ae(null),y&&f&&(f.kind==="resize"&&f.payload&&l&&l(f.payload),f.kind==="select"&&h&&(f.currentDate!==f.anchorDate||f.currentMinute!==f.anchorMinute)&&h(Ue({dateOnly:f.anchorDate,minuteOfDay:f.anchorMinute},{dateOnly:f.currentDate,minuteOfDay:f.currentMinute}))),X({type:y?"COMMIT":"CANCEL"})},p=y=>{P.current&&y.pointerId!==P.current.pointerId||d(!0)},w=y=>{P.current&&y.pointerId!==P.current.pointerId||d(!1)},D=y=>{y.key==="Escape"&&d(!1)};return window.addEventListener("pointermove",o),window.addEventListener("pointerup",p),window.addEventListener("pointercancel",w),window.addEventListener("keydown",D),()=>{window.removeEventListener("pointermove",o),window.removeEventListener("pointerup",p),window.removeEventListener("pointercancel",w),window.removeEventListener("keydown",D)}},[le,a,T.config,l,h]);let ve=C.useCallback((o,d)=>p=>{if(!m||p.target.closest("[data-event-id], button"))return;if(p.preventDefault(),!d){m({start:`${o}T00:00:00`});return}let w=Ie(gt(p.clientY,p.currentTarget),T.config),D=v(`${o}T00:00:00`),y=new Date(D.getFullYear(),D.getMonth(),D.getDate(),0,w,0);m({start:F(y)})},[m,T.config]),he=C.useId(),V=C.useMemo(()=>T.columns.map(o=>o.dateOnly),[T.columns]),[A,ce]=C.useState(()=>(V.includes(G)?G:V[0])??""),[$,j]=C.useState(null),[N,ue]=C.useState(null),[Pe,me]=C.useState("");C.useEffect(()=>{V.includes(A)||(ce(V[0]??""),j(null),ue(null))},[V,A]);let R=o=>`${he}-col-${o}`,x=(o,d)=>`${he}-e-${o}-${d}`,S=`${he}-hint`,Q=Se,Y=C.useCallback(o=>!!b||o.editable!==!1&&!!(c||l),[b,c,l]),K=C.useMemo(()=>{let o=T.columns.find(d=>d.dateOnly===A);return o?[...o.allDay,...o.timed.map(d=>d.event)]:[]},[T.columns,A]),O=C.useMemo(()=>K.filter(o=>Y(o)),[K,Y]);C.useEffect(()=>{let o=new Set(O.map(d=>d.id));N&&!o.has(N.eventId)?(ue(null),j(null)):!N&&$!==null&&!o.has($)&&j(null)},[O,$,N]);let _e=N?x(A,N.eventId):$?x(A,$):R(A),je=C.useCallback(o=>{let d=N;if(!d)return;let p=d.dateOnly,w=d.minute,D=a.find(f=>f.id===d.eventId),y=D?.allDay===!0;if(!y&&(o==="ArrowUp"||o==="ArrowDown")){let f=Ct(p,w,o==="ArrowUp"?-Q:Q,T.config);p=f.dateOnly,w=f.minuteOfDay}else o==="ArrowLeft"?p=pe(p,-1):o==="ArrowRight"&&(p=pe(p,1));if(!(p===d.dateOnly&&w===d.minute)){if(D)if(d.kind==="move")me(u.movedTo(y?Ge(p,r):`${Ge(p,r)} ${Vt(p,w,r)}`));else{let f=Be(D,"end",p,w);me(u.resizedTo(`${oe(f.start,r)} \u2013 ${oe(f.end,r)}`))}ue({...d,dateOnly:p,minute:w,moved:!0})}},[N,Q,T.config,a,u,r]),Ze=C.useCallback(()=>{let o=N;if(!o)return;if(!o.moved){j(o.eventId),ue(null);return}let d=a.find(p=>p.id===o.eventId);if(d&&d.editable!==!1&&o.kind==="move"&&c){let p=at(d,o.dateOnly,d.allDay===!0?null:o.minute);c(p);let w=re(p.start);ce(V.includes(w)?w:A),j(null),me(u.dropped(d.allDay===!0?Ge(o.dateOnly,r):Vt(o.dateOnly,o.minute,r)))}else if(d&&d.editable!==!1&&o.kind==="resize"&&l){let p=Be(d,"end",o.dateOnly,o.minute);l(p),j(o.eventId),me(u.resized(`${oe(p.start,r)} \u2013 ${oe(p.end,r)}`))}else j(o.eventId);ue(null)},[N,a,c,l,V,A,u,r]),pt=C.useCallback(o=>{let{key:d}=o,p=d==="Enter"||d===" "||d==="Spacebar",w=d==="ArrowUp"||d==="ArrowDown"||d==="ArrowLeft"||d==="ArrowRight";if(N){if(w){o.preventDefault(),je(d);return}if(p){o.preventDefault(),Ze();return}if(d==="Escape"){o.preventDefault(),ue(null),me(u.cancelled);return}return}if($){let D=O.findIndex(y=>y.id===$);if(d==="ArrowDown"){o.preventDefault(),D>=0&&D<O.length-1&&j(O[D+1].id);return}if(d==="ArrowUp"){o.preventDefault(),D>0?j(O[D-1].id):j(null);return}if(d==="ArrowLeft"||d==="ArrowRight"){o.preventDefault(),j(null);let y=V.indexOf(A);ce(V[Me(y,d,1,V.length)]);return}if(p){o.preventDefault();let y=O.find(f=>f.id===$);if(!y)return;y.editable!==!1&&c?(ue({kind:"move",eventId:y.id,dateOnly:re(y.start),minute:xn(y.start),moved:!1}),me(u.grabbedMoveHint(y.title))):b&&b({id:y.id});return}if((d==="r"||d==="R")&&l){o.preventDefault();let y=O.find(f=>f.id===$);y&&y.allDay!==!0&&y.editable!==!1&&(ue({kind:"resize",eventId:y.id,dateOnly:re(y.end),minute:xn(y.end),moved:!1}),me(u.grabbedResizeHint(y.title)));return}if(d==="Escape"){o.preventDefault(),j(null);return}return}if(d==="ArrowLeft"||d==="ArrowRight"||d==="Home"||d==="End"){o.preventDefault();let D=V.indexOf(A);ce(V[Me(D,d,1,V.length)]);return}if(d==="ArrowDown"){O.length>0&&(o.preventDefault(),j(O[0].id));return}if(p){if(O.length>0)o.preventDefault(),j(O[0].id);else if(K.length===0&&h){let D=T.config.dayEndHour*60,y=nt(T.config.dayStartHour*60,T.config),f=Math.min(y+60,D);f>y&&(o.preventDefault(),h(Ue({dateOnly:A,minuteOfDay:y},{dateOnly:A,minuteOfDay:f})),me(u.createHere(`${Ge(A,r)} ${Vt(A,y,r)}`)))}}},[N,$,A,K,O,V,c,l,b,h,je,Ze,T.config,u,r]),B={"--ac-tg-cols":T.columns.length,"--ac-tg-hours":T.config.dayEndHour-T.config.dayStartHour,...g??{}},ft=u.allDay;return we(Tn,{children:[we("div",{className:ut("aethercal-calendar","aethercal-timegrid",J&&"is-dragging",H.status==="resizing"&&"is-resizing",H.status==="selecting"&&"is-selecting"),role:"grid","aria-label":hn(n,r),"aria-describedby":S,"aria-activedescendant":_e,tabIndex:0,"data-view":t,style:B,onKeyDown:pt,children:[we("div",{className:"aethercal-tg-head",role:"row",children:[Z("div",{className:"aethercal-tg-corner"}),T.columns.map(o=>Z("div",{role:"columnheader",className:ut("aethercal-tg-colhead",o.dateOnly===G&&"is-today"),"data-date":o.dateOnly,children:Z("span",{className:"aethercal-tg-colhead-date",children:Ge(o.dateOnly,r)})},o.dateOnly))]}),we("div",{className:"aethercal-tg-allday",role:"row",children:[Z("div",{className:"aethercal-tg-rowhead",role:"rowheader",children:ft}),T.columns.map(o=>Z("div",{role:"gridcell",className:"aethercal-tg-allday-cell","data-date":o.dateOnly,onDragOver:se?d=>d.preventDefault():void 0,onDrop:se?U(o.dateOnly,!1):void 0,onContextMenu:m?ve(o.dateOnly,!1):void 0,children:o.allDay.map(d=>{let p=N?.eventId===d.id&&o.dateOnly===A||!N&&$===d.id&&o.dateOnly===A;return Z(dt,{id:x(o.dateOnly,d.id),event:d,interactive:Y(d),isActive:p,isGrabbed:N?.eventId===d.id&&o.dateOnly===A,timeLabel:null,onDragStart:M,onDragEnd:q,isPending:k.has(d.id),isRolledBack:E.has(d.id),...b?{onClick:()=>b({id:d.id})}:{},...m?{onContextMenu:()=>m({id:d.id})}:{}},d.id)})},o.dateOnly))]}),we("div",{className:"aethercal-tg-body",role:"row",children:[Z("div",{className:"aethercal-tg-gutter",role:"presentation","aria-hidden":"true",children:T.hourMarks.map(o=>Z("div",{className:"aethercal-tg-hour",style:{top:De(o.topFraction)},children:vn(o.hour,r)},o.hour))}),T.columns.map(o=>{let d=!$&&!N&&o.dateOnly===A,p=N?.dateOnly===o.dateOnly;return we("div",{id:R(o.dateOnly),role:"gridcell",className:ut("aethercal-tg-col",o.dateOnly===G&&"is-today",d&&"is-active",p&&"is-drop-target"),"data-date":o.dateOnly,onDragOver:se?w=>w.preventDefault():void 0,onDrop:se?U(o.dateOnly,!0):void 0,onPointerDown:de?ye(o.dateOnly):void 0,onContextMenu:m?ve(o.dateOnly,!0):void 0,children:[T.hourMarks.map(w=>Z("div",{className:"aethercal-tg-line",style:{top:De(w.topFraction)},"aria-hidden":"true"},w.hour)),te&&te.dateOnly===o.dateOnly?Z("div",{className:"aethercal-tg-select-band",style:{top:De(te.topFraction),height:De(te.heightFraction)},"aria-hidden":"true"}):null,o.timed.map(w=>{let{event:D}=w,y=D.editable!==!1,f=na(w,r,u.continues,u.endsAt),ne=W?.id===D.id?W:null,ee=ne?Ye([{...D,start:ne.start,end:ne.end}],o.dateOnly,T.config)[0]:void 0,Oe=ee?ee.topFraction:w.topFraction,$e=ee?ee.heightFraction:w.heightFraction,Ee=N?.eventId===D.id&&o.dateOnly===A||!N&&$===D.id&&o.dateOnly===A,yt=N?.eventId===D.id&&o.dateOnly===A,wn={top:De(Oe),height:De($e),left:De(w.lane/w.laneCount),width:De(1/w.laneCount),...D.color?{"--ac-tg-event-accent":D.color}:{}};return we("div",{id:x(o.dateOnly,D.id),className:ut("aethercal-tg-event",!y&&"is-locked",k.has(D.id)&&"is-pending",E.has(D.id)&&"is-rolledback",!!ne&&"is-resizing",Ee&&"is-active",yt&&"is-grabbed"),...Y(D)?{role:"button"}:{},draggable:y,"data-event-id":D.id,"data-lane":w.lane,"data-lane-count":w.laneCount,"aria-label":`${f} ${D.title}`,title:D.title,style:wn,onDragStart:Le=>{if(P.current?.kind==="resize"){Le.preventDefault();return}Le.dataTransfer.setData("text/plain",D.id),Le.dataTransfer.effectAllowed="move",M(D.id)},onDragEnd:q,onClick:b?()=>b({id:D.id}):void 0,onContextMenu:m?Le=>{Le.preventDefault(),Le.stopPropagation(),m({id:D.id})}:void 0,children:[Z("time",{className:"aethercal-tg-event-time",children:f})," ",Z("span",{className:"aethercal-tg-event-title",children:D.title}),_&&y?we(Tn,{children:[Z("div",{className:"aethercal-tg-resize-handle aethercal-tg-resize-handle-start","data-edge":"start","aria-hidden":"true",draggable:!1,onPointerDown:Re(D,"start")}),Z("div",{className:"aethercal-tg-resize-handle aethercal-tg-resize-handle-end","data-edge":"end","aria-hidden":"true",draggable:!1,onPointerDown:Re(D,"end")})]}):null]},D.id)}),z!==null&&o.dateOnly===G?Z("div",{className:"aethercal-now-indicator",style:{top:De(z)},"aria-hidden":"true"}):null]},o.dateOnly)})]})]}),Z(st,{id:S,text:u.keyboardHint}),Z(ot,{message:Pe})]})}import{jsx as Xe,jsxs as oa}from"react/jsx-runtime";function aa(e){if(e instanceof Date)return e;if(typeof e=="string"){let t=e.trim();if(t==="")return new Date;try{return v(t)}catch{return new Date}}return new Date}function ra(e){return e instanceof Date?e:typeof e=="string"?v(e):new Date}function mt(e){let{view:t="month",events:n,anchor:a,locale:r="en",theme:i,messages:s,firstDayOfWeek:g=1,maxEventsPerDay:c=3,weekdayLabels:l,formatMore:h,unavailableLabel:b,dayStartHour:m,dayEndHour:k,allDayLabel:E,now:u,continuesLabel:T,formatEndsLabel:z,agendaEmptyLabel:G,onEventDrop:H,onEventResize:X,onRangeSelect:P,onEventClick:W,onContextMenu:I,navigation:te=!1,navigationViews:Ae=!0,onRangeChange:se,onViewChange:_,pendingIds:de,rolledBackIds:J}=e;ge.useEffect(()=>{Je()},[]);let U=ge.useMemo(()=>aa(a),[a]),M=ge.useMemo(()=>zt(i),[i]),q=ge.useMemo(()=>{let $={...E!==void 0?{allDay:E}:{},...T!==void 0?{continues:T}:{},...z!==void 0?{endsAt:z}:{},...G!==void 0?{noEvents:G}:{},...b!==void 0?{unavailable:b}:{},...h!==void 0?{more:h}:{},...s};return We(r,$)},[r,E,T,z,G,b,h,s]),[Re,ye]=ge.useState(()=>new Date);ge.useEffect(()=>{if(u!==void 0||t!=="week"&&t!=="day")return;let $=setInterval(()=>ye(new Date),6e4);return()=>clearInterval($)},[u,t]);let le=ge.useMemo(()=>u!==void 0?ra(u):Re,[u,Re]),ve=Number.isInteger(g)&&g>=0&&g<=6?g:1,he=Number.isInteger(c)&&c>=0?c:3,V=l&&l.length===7?l:void 0,A=ge.useMemo(()=>({...m!==void 0?{dayStartHour:m}:{},...k!==void 0?{dayEndHour:k}:{}}),[m,k]),ce=(()=>{if(t==="list")return Xe(en,{events:n??[],locale:r,messages:q,themeVars:M});if(t==="month")return Xe(ln,{events:n??[],anchor:U,locale:r,messages:q,themeVars:M,firstDayOfWeek:ve,maxEventsPerDay:he,...V?{weekdayLabels:V}:{},...H?{onEventDrop:H}:{},...P?{onRangeSelect:P}:{},...W?{onEventClick:W}:{},...I?{onContextMenu:I}:{},...de?{pendingIds:de}:{},...J?{rolledBackIds:J}:{}});if(t==="week"||t==="day"){let $=t==="week"?vt(U,ve):[re(F(U))];return Xe(Bt,{view:t,days:$,events:n??[],locale:r,messages:q,themeVars:M,config:A,now:le,...H?{onEventDrop:H}:{},...X?{onEventResize:X}:{},...P?{onRangeSelect:P}:{},...W?{onEventClick:W}:{},...I?{onContextMenu:I}:{},...de?{pendingIds:de}:{},...J?{rolledBackIds:J}:{}})}return Xe("div",{className:"aethercal-calendar aethercal-unavailable",role:"status","data-view":t,style:M,children:q.unavailable})})();return te?oa("div",{className:"aethercal-calendar-shell",style:M,children:[Xe(Ft,{view:t,anchor:U,now:le,locale:r,firstDayOfWeek:ve,messages:q,showViews:Ae,...se?{onRangeChange:se}:{},..._?{onViewChange:_}:{}}),ce]}):ce}var ia=mt;import*as ie from"react";function sa(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`cm-${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}var da=8e3,la=900;function Ut(e){let{events:t,mutate:n,timeoutMs:a=da,rollbackFlashMs:r=la,generateId:i=sa}=e,[s,g]=ie.useReducer(kt,Mt),c=ie.useRef(t);c.current=t;let l=ie.useRef(!0),h=ie.useRef(new Map);ie.useEffect(()=>{l.current=!0;let k=h.current;return()=>{l.current=!1;for(let E of k.values())clearTimeout(E);k.clear()}},[]),ie.useEffect(()=>{for(let k of It(t,s)){let E=s.overrides[k];g({type:"CLEAR",id:k,...E?{clientMutationId:E.clientMutationId}:{}})}},[t,s]);let b=ie.useCallback((k,E)=>{let u=i(),T=c.current.find(I=>I.id===E.id),z=h.current,G=I=>{let te=z.get(I);te!==void 0&&(clearTimeout(te),z.delete(I))},H=()=>{z.set(`fl:${u}`,setTimeout(()=>{z.delete(`fl:${u}`),l.current&&g({type:"CLEAR",id:E.id,clientMutationId:u})},r))};g({type:"SUBMIT",id:E.id,clientMutationId:u,start:E.start,end:E.end,...T?.revision!==void 0?{baseRevision:T.revision}:{}}),z.set(`to:${u}`,setTimeout(()=>{z.delete(`to:${u}`),l.current&&(g({type:"TIMEOUT",id:E.id,clientMutationId:u}),H())},a));let X=()=>{G(`to:${u}`),l.current&&(g({type:"REJECT",id:E.id,clientMutationId:u}),H())},P={kind:k,clientMutationId:u,payload:{...E,client_mutation_id:u}},W;try{W=n(P)}catch(I){W=Promise.reject(I instanceof Error?I:new Error(String(I)))}W.then(I=>{if(I.id!==E.id){X();return}G(`to:${u}`),l.current&&g({type:"RESOLVE",id:I.id,clientMutationId:u,start:I.start,end:I.end,revision:I.revision})}).catch(X)},[n,a,r,i]),m=ie.useMemo(()=>St(t,s),[t,s]);return{events:m.events,pendingIds:m.pendingIds,rolledBackIds:m.rolledBackIds,submit:b}}import{jsx as ua}from"react/jsx-runtime";function ca({events:e,mutate:t,timeoutMs:n,rollbackFlashMs:a,generateId:r,...i}){let{events:s,pendingIds:g,rolledBackIds:c,submit:l}=Ut({events:e,mutate:t,...n!==void 0?{timeoutMs:n}:{},...a!==void 0?{rollbackFlashMs:a}:{},...r?{generateId:r}:{}});return ua(mt,{...i,events:s,pendingIds:g,rolledBackIds:c,onEventDrop:h=>l("drop",h),onEventResize:h=>l("resize",h)})}export{mt as AetherCalendar,yn as CALENDAR_CSS,Ft as CalendarNav,Gt as DEFAULT_LOCALE_MESSAGES,ca as OptimisticCalendar,ct as PRESETS,un as PRESET_NAMES,Dn as TIME_GRID_CSS,Bt as TimeGridView,ia as default,_t as defaultBaseTokenCss,$t as defaultTimeGridTokenCss,Je as ensureCalendarStyles,Ht as ensureTimeGridStyles,He as getVisibleRange,mn as isThemePreset,v as parseLocalDateTime,We as resolveMessages,zt as resolveThemeVars,Ve as stepAnchor,Ut as useOptimisticEvents};

...
`;function Je(){if(typeof document>"u"||document.getElementById(bt))return;let e=document.createElement("style");e.id=bt,e.textContent=Dt,document.head.appendChild(e)}import{Fragment as zt,jsx as A,jsxs as ie}from"react/jsx-runtime";function be(...e){return e.filter(Boolean).join(" ")}var Q=e=>`${e*100}%`,Et=new Set;function De(e,t){let n=t.getBoundingClientRect();return n.height>0?(e-n.top)/n.height:0}function Xe(e){let{view:t,days:n,events:a,locale:r,config:i,now:o,allDayLabel:u=ft,onEventDrop:s,onEventResize:d,onRangeSelect:l,onEventClick:m,onContextMenu:c,pendingIds:D=Et,rolledBackIds:f=Et}=e;C.useEffect(()=>{ue(),Je()},[]);let h=C.useMemo(()=>Ve(n,a,i),[n,a,i]),$=C.useMemo(()=>Ue(o,i),[o,i]),T=C.useMemo(()=>U(k(o)),[o]),[w,S]=C.useReducer(Ae,me),E=C.useRef(null),[O,P]=C.useState(null),[R,Y]=C.useState(null),W=!!s,B=!!d,N=!!l,M=w.status==="dragging",V=C.useCallback((y,b)=>p=>{if(p.preventDefault(),w.status!=="dragging"){S({type:"COMMIT"});return}let I=w.eventId,G=p.dataTransfer.getData("text/plain");if(S({type:"COMMIT"}),G&&G!==I||!s)return;let x=a.find(K=>K.id===I);if(!x||x.editable===!1)return;let v=null;if(b&&x.allDay!==!0){let z=p.currentTarget.getBoundingClientRect();z.height>0&&Number.isFinite(p.clientY)&&(v=ne((p.clientY-z.top)/z.height,h.config))}s(_e(x,y,v))},[w,a,s,h.config]),_=C.useCallback(y=>{E.current?.kind!=="resize"&&S({type:"DRAG_START",eventId:y})},[]),X=C.useCallback(()=>S({type:"CANCEL"}),[]),j=C.useCallback((y,b)=>p=>{if(!d||y.editable===!1||p.button!==0||E.current)return;let I=p.currentTarget.closest(".aethercal-tg-col");I?.dataset.date&&(p.preventDefault(),p.stopPropagation(),E.current={kind:"resize",pointerId:p.pointerId,eventId:y.id,edge:b,dateOnly:I.dataset.date,colEl:I,payload:null},p.currentTarget.setPointerCapture?.(p.pointerId),S({type:"RESIZE_START",eventId:y.id,edge:b}))},[d]),Re=C.useCallback(y=>b=>{if(!l||b.button!==0||E.current||b.target.closest("[data-event-id], button"))return;let p=b.currentTarget,I=ne(De(b.clientY,p),h.config);E.current={kind:"select",pointerId:b.pointerId,anchorDate:y,anchorCol:p,anchorMinute:I,currentDate:y,currentCol:p,currentMinute:I},p.setPointerCapture?.(b.pointerId),S({type:"SELECT_START",point:{dateOnly:y,minuteOfDay:I}})},[l,h.config]),Te=w.status==="resizing"||w.status==="selecting";C.useEffect(()=>{if(!Te)return;let y=x=>{let v=E.current;if(!(!v||x.pointerId!==v.pointerId))if(v.kind==="resize"){let K=document.elementFromPoint(x.clientX,x.clientY)?.closest(".aethercal-tg-col"),z=K?.dataset.date?K:v.colEl,oe=ne(De(x.clientY,z),h.config),J=a.find(xt=>xt.id===v.eventId);if(!J)return;let se=Ge(J,v.edge,z.dataset.date??v.dateOnly,oe);v.payload=se,P(se)}else{let K=document.elementFromPoint(x.clientX,x.clientY)?.closest(".aethercal-tg-col"),z=K?.dataset.date?K:v.currentCol;v.currentCol=z,v.currentDate=z.dataset.date??v.anchorDate,v.currentMinute=ne(De(x.clientY,z),h.config);let oe=fe({dateOnly:v.anchorDate,minuteOfDay:v.anchorMinute},{dateOnly:v.currentDate,minuteOfDay:v.currentMinute}),se=(v.currentDate===v.anchorDate?ce([{id:"__sel",title:"",start:oe.start,end:oe.end}],v.anchorDate,h.config):[])[0];Y(se?{dateOnly:v.anchorDate,topFraction:se.topFraction,heightFraction:se.heightFraction}:null)}},b=x=>{let v=E.current;E.current=null,P(null),Y(null),x&&v&&(v.kind==="resize"&&v.payload&&d&&d(v.payload),v.kind==="select"&&l&&(v.currentDate!==v.anchorDate||v.currentMinute!==v.anchorMinute)&&l(fe({dateOnly:v.anchorDate,minuteOfDay:v.anchorMinute},{dateOnly:v.currentDate,minuteOfDay:v.currentMinute}))),S({type:x?"COMMIT":"CANCEL"})},p=x=>{E.current&&x.pointerId!==E.current.pointerId||b(!0)},I=x=>{E.current&&x.pointerId!==E.current.pointerId||b(!1)},G=x=>{x.key==="Escape"&&b(!1)};return window.addEventListener("pointermove",y),window.addEventListener("pointerup",p),window.addEventListener("pointercancel",I),window.addEventListener("keydown",G),()=>{window.removeEventListener("pointermove",y),window.removeEventListener("pointerup",p),window.removeEventListener("pointercancel",I),window.removeEventListener("keydown",G)}},[Te,a,h.config,d,l]);let L=C.useCallback((y,b)=>p=>{if(!c||p.target.closest("[data-event-id], button"))return;if(p.preventDefault(),!b){c({start:`${y}T00:00:00`});return}let I=ne(De(p.clientY,p.currentTarget),h.config),G=g(`${y}T00:00:00`),x=new Date(G.getFullYear(),G.getMonth(),G.getDate(),0,I,0);c({start:k(x)})},[c,h.config]),Me={"--ac-tg-cols":h.columns.length,"--ac-tg-hours":h.config.dayEndHour-h.config.dayStartHour};return ie("div",{className:be("aethercal-calendar","aethercal-timegrid",M&&"is-dragging",w.status==="resizing"&&"is-resizing",w.status==="selecting"&&"is-selecting"),role:"grid","aria-label":ht(n,r),"data-view":t,style:Me,children:[ie("div",{className:"aethercal-tg-head",role:"row",children:[A("div",{className:"aethercal-tg-corner"}),h.columns.map(y=>A("div",{role:"columnheader",className:be("aethercal-tg-colhead",y.dateOnly===T&&"is-today"),"data-date":y.dateOnly,children:A("span",{className:"aethercal-tg-colhead-date",children:yt(y.dateOnly,r)})},y.dateOnly))]}),ie("div",{className:"aethercal-tg-allday",role:"row",children:[A("div",{className:"aethercal-tg-rowhead",role:"rowheader",children:u}),h.columns.map(y=>A("div",{role:"gridcell",className:"aethercal-tg-allday-cell","data-date":y.dateOnly,onDragOver:W?b=>b.preventDefault():void 0,onDrop:W?V(y.dateOnly,!1):void 0,onContextMenu:c?L(y.dateOnly,!1):void 0,children:y.allDay.map(b=>A(he,{event:b,timeLabel:null,onDragStart:_,onDragEnd:X,isPending:D.has(b.id),isRolledBack:f.has(b.id),...m?{onClick:()=>m({id:b.id})}:{},...c?{onContextMenu:()=>c({id:b.id})}:{}},b.id))},y.dateOnly))]}),ie("div",{className:"aethercal-tg-body",role:"row",children:[A("div",{className:"aethercal-tg-gutter",role:"presentation","aria-hidden":"true",children:h.hourMarks.map(y=>A("div",{className:"aethercal-tg-hour",style:{top:Q(y.topFraction)},children:vt(y.hour,r)},y.hour))}),h.columns.map(y=>ie("div",{role:"gridcell",className:be("aethercal-tg-col",y.dateOnly===T&&"is-today"),"data-date":y.dateOnly,onDragOver:W?b=>b.preventDefault():void 0,onDrop:W?V(y.dateOnly,!0):void 0,onPointerDown:N?Re(y.dateOnly):void 0,onContextMenu:c?L(y.dateOnly,!0):void 0,children:[h.hourMarks.map(b=>A("div",{className:"aethercal-tg-line",style:{top:Q(b.topFraction)},"aria-hidden":"true"},b.hour)),R&&R.dateOnly===y.dateOnly?A("div",{className:"aethercal-tg-select-band",style:{top:Q(R.topFraction),height:Q(R.heightFraction)},"aria-hidden":"true"}):null,y.timed.map(b=>{let{event:p}=b,I=p.editable!==!1,G=ae(p.start,r),x=O?.id===p.id?O:null,v=x?ce([{...p,start:x.start,end:x.end}],y.dateOnly,h.config)[0]:void 0,K=v?v.topFraction:b.topFraction,z=v?v.heightFraction:b.heightFraction,oe={top:Q(K),height:Q(z),left:Q(b.lane/b.laneCount),width:Q(1/b.laneCount),...p.color?{"--ac-tg-event-accent":p.color}:{}};return ie("div",{className:be("aethercal-tg-event",!I&&"is-locked",D.has(p.id)&&"is-pending",f.has(p.id)&&"is-rolledback",!!x&&"is-resizing"),draggable:I,"data-event-id":p.id,"data-lane":b.lane,"data-lane-count":b.laneCount,"aria-label":`${G} ${p.title}`,title:p.title,style:oe,onDragStart:J=>{if(E.current?.kind==="resize"){J.preventDefault();return}J.dataTransfer.setData("text/plain",p.id),J.dataTransfer.effectAllowed="move",_(p.id)},onDragEnd:X,onClick:m?()=>m({id:p.id}):void 0,onContextMenu:c?J=>{J.preventDefault(),J.stopPropagation(),c({id:p.id})}:void 0,children:[A("time",{className:"aethercal-tg-event-time",children:G}),A("span",{className:"aethercal-tg-event-title",children:p.title}),B&&I?ie(zt,{children:[A("div",{className:"aethercal-tg-resize-handle aethercal-tg-resize-handle-start","data-edge":"start","aria-hidden":"true",draggable:!1,onPointerDown:j(p,"start")}),A("div",{className:"aethercal-tg-resize-handle aethercal-tg-resize-handle-end","data-edge":"end","aria-hidden":"true",draggable:!1,onPointerDown:j(p,"end")})]}):null]},p.id)}),$!==null&&y.dateOnly===T?A("div",{className:"aethercal-now-indicator",style:{top:Q($)},"aria-hidden":"true"}):null]},y.dateOnly))]})]})}import{jsx as Ee}from"react/jsx-runtime";function Ht(e){return e instanceof Date?e:typeof e=="string"?g(e):new Date}function $t(e){return e instanceof Date?e:typeof e=="string"?g(e):new Date}var Yt=e=>`+${e} more`,Bt=e=>`ends ${e}`;function xe(e){let{view:t="month",events:n,anchor:a,locale:r="en",firstDayOfWeek:i=1,maxEventsPerDay:o=3,weekdayLabels:u,formatMore:s=Yt,unavailableLabel:d="This view is not available yet.",dayStartHour:l,dayEndHour:m,allDayLabel:c="All day",now:D,continuesLabel:f="Continues",formatEndsLabel:h=Bt,agendaEmptyLabel:$="No events",onEventDrop:T,onEventResize:w,onRangeSelect:S,onEventClick:E,onContextMenu:O,pendingIds:P,rolledBackIds:R}=e;ee.useEffect(()=>{ue()},[]);let Y=ee.useMemo(()=>Ht(a),[a]),[W,B]=ee.useState(()=>new Date);ee.useEffect(()=>{if(D!==void 0||t!=="week"&&t!=="day")return;let j=setInterval(()=>B(new Date),6e4);return()=>clearInterval(j)},[D,t]);let N=ee.useMemo(()=>D!==void 0?$t(D):W,[D,W]),M=Number.isInteger(i)&&i>=0&&i<=6?i:1,V=Number.isInteger(o)&&o>=0?o:3,_=u&&u.length===7?u:void 0,X=ee.useMemo(()=>({...l!==void 0?{dayStartHour:l}:{},...m!==void 0?{dayEndHour:m}:{}}),[l,m]);if(t==="list")return Ee(st,{events:n??[],locale:r,allDayLabel:c,continuesLabel:f,formatEndsLabel:h,emptyLabel:$});if(t==="month")return Ee(gt,{events:n??[],anchor:Y,locale:r,firstDayOfWeek:M,maxEventsPerDay:V,formatMore:s,..._?{weekdayLabels:_}:{},...T?{onEventDrop:T}:{},...E?{onEventClick:E}:{},...O?{onContextMenu:O}:{},...P?{pendingIds:P}:{},...R?{rolledBackIds:R}:{}});if(t==="week"||t==="day"){let j=t==="week"?we(Y,M):[U(k(Y))];return Ee(Xe,{view:t,days:j,events:n??[],locale:r,config:X,now:N,allDayLabel:c,...T?{onEventDrop:T}:{},...w?{onEventResize:w}:{},...S?{onRangeSelect:S}:{},...E?{onEventClick:E}:{},...O?{onContextMenu:O}:{},...P?{pendingIds:P}:{},...R?{rolledBackIds:R}:{}})}return Ee("div",{className:"aethercal-calendar aethercal-unavailable",role:"status","data-view":t,children:d})}var Vt=xe;import*as F from"react";function Ut(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`cm-${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}var Wt=8e3,Kt=900;function je(e){let{events:t,mutate:n,timeoutMs:a=Wt,rollbackFlashMs:r=Kt,generateId:i=Ut}=e,[o,u]=F.useReducer(He,ze),s=F.useRef(t);s.current=t;let d=F.useRef(!0),l=F.useRef(new Map);F.useEffect(()=>{d.current=!0;let D=l.current;return()=>{d.current=!1;for(let f of D.values())clearTimeout(f);D.clear()}},[]),F.useEffect(()=>{for(let D of Ye(t,o)){let f=o.overrides[D];u({type:"CLEAR",id:D,...f?{clientMutationId:f.clientMutationId}:{}})}},[t,o]);let m=F.useCallback((D,f)=>{let h=i(),$=s.current.find(R=>R.id===f.id),T=l.current,w=R=>{let Y=T.get(R);Y!==void 0&&(clearTimeout(Y),T.delete(R))},S=()=>{T.set(`fl:${h}`,setTimeout(()=>{T.delete(`fl:${h}`),d.current&&u({type:"CLEAR",id:f.id,clientMutationId:h})},r))};u({type:"SUBMIT",id:f.id,clientMutationId:h,start:f.start,end:f.end,...$?.revision!==void 0?{baseRevision:$.revision}:{}}),T.set(`to:${h}`,setTimeout(()=>{T.delete(`to:${h}`),d.current&&(u({type:"TIMEOUT",id:f.id,clientMutationId:h}),S())},a));let E=()=>{w(`to:${h}`),d.current&&(u({type:"REJECT",id:f.id,clientMutationId:h}),S())},O={kind:D,clientMutationId:h,payload:{...f,client_mutation_id:h}},P;try{P=n(O)}catch(R){P=Promise.reject(R instanceof Error?R:new Error(String(R)))}P.then(R=>{if(R.id!==f.id){E();return}w(`to:${h}`),d.current&&u({type:"RESOLVE",id:R.id,clientMutationId:h,start:R.start,end:R.end,revision:R.revision})}).catch(E)},[n,a,r,i]),c=F.useMemo(()=>$e(t,o),[t,o]);return{events:c.events,pendingIds:c.pendingIds,rolledBackIds:c.rolledBackIds,submit:m}}import{jsx as Xt}from"react/jsx-runtime";function Jt({events:e,mutate:t,timeoutMs:n,rollbackFlashMs:a,generateId:r,...i}){let{events:o,pendingIds:u,rolledBackIds:s,submit:d}=je({events:e,mutate:t,...n!==void 0?{timeoutMs:n}:{},...a!==void 0?{rollbackFlashMs:a}:{},...r?{generateId:r}:{}});return Xt(xe,{...i,events:o,pendingIds:u,rolledBackIds:s,onEventDrop:l=>d("drop",l),onEventResize:l=>d("resize",l)})}export{xe as AetherCalendar,mt as CALENDAR_CSS,Jt as OptimisticCalendar,Dt as TIME_GRID_CSS,Xe as TimeGridView,Vt as default,ue as ensureCalendarStyles,Je as ensureTimeGridStyles,je as useOptimisticEvents};

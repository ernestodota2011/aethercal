...
`;function Ve(){if(typeof document>"u"||document.getElementById(ht))return;let e=document.createElement("style");e.id=ht,e.textContent=bt,document.head.appendChild(e)}import{Fragment as Gt,jsx as A,jsxs as oe}from"react/jsx-runtime";function be(...e){return e.filter(Boolean).join(" ")}var Q=e=>`${e*100}%`,Et=new Set;function Ee(e,t){let n=t.getBoundingClientRect();return n.height>0?(e-n.top)/n.height:0}function We(e){let{view:t,days:n,events:a,locale:r,config:i,now:o,allDayLabel:l=mt,onEventDrop:s,onEventResize:d,onRangeSelect:c,onEventClick:b,onContextMenu:u,pendingIds:E=Et,rolledBackIds:m=Et}=e;w.useEffect(()=>{ce(),Ve()},[]);let v=w.useMemo(()=>$e(n,a,i),[n,a,i]),$=w.useMemo(()=>Be(o,i),[o,i]),T=w.useMemo(()=>V(k(o)),[o]),[C,S]=w.useReducer(Ae,pe),D=w.useRef(null),[O,P]=w.useState(null),[x,B]=w.useState(null),W=!!s,Y=!!d,N=!!c,M=C.status==="dragging",U=w.useCallback((f,h)=>p=>{if(p.preventDefault(),C.status!=="dragging"){S({type:"COMMIT"});return}let I=C.eventId,G=p.dataTransfer.getData("text/plain");if(S({type:"COMMIT"}),G&&G!==I||!s)return;let R=a.find(X=>X.id===I);if(!R||R.editable===!1)return;let y=null;if(h&&R.allDay!==!0){let z=p.currentTarget.getBoundingClientRect();z.height>0&&Number.isFinite(p.clientY)&&(y=ae((p.clientY-z.top)/z.height,v.config))}s(Oe(R,f,y))},[C,a,s,v.config]),_=w.useCallback(f=>{D.current?.kind!=="resize"&&S({type:"DRAG_START",eventId:f})},[]),K=w.useCallback(()=>S({type:"CANCEL"}),[]),J=w.useCallback((f,h)=>p=>{if(!d||f.editable===!1||p.button!==0)return;let I=p.currentTarget.closest(".aethercal-tg-col");I?.dataset.date&&(p.preventDefault(),p.stopPropagation(),D.current={kind:"resize",pointerId:p.pointerId,eventId:f.id,edge:h,dateOnly:I.dataset.date,colEl:I,payload:null},p.currentTarget.setPointerCapture?.(p.pointerId),S({type:"RESIZE_START",eventId:f.id,edge:h}))},[d]),Re=w.useCallback(f=>h=>{if(!c||h.button!==0||h.target.closest("[data-event-id], button"))return;let p=h.currentTarget,I=ae(Ee(h.clientY,p),v.config);D.current={kind:"select",pointerId:h.pointerId,anchorDate:f,anchorCol:p,anchorMinute:I,currentDate:f,currentCol:p,currentMinute:I},p.setPointerCapture?.(h.pointerId),S({type:"SELECT_START",point:{dateOnly:f,minuteOfDay:I}})},[c,v.config]),Te=C.status==="resizing"||C.status==="selecting";w.useEffect(()=>{if(!Te)return;let f=R=>{let y=D.current;if(!(!y||R.pointerId!==y.pointerId))if(y.kind==="resize"){let X=ae(Ee(R.clientY,y.colEl),v.config),z=a.find(j=>j.id===y.eventId);if(!z)return;let ne=Fe(z,y.edge,y.dateOnly,X);y.payload=ne,P(ne)}else{let X=document.elementFromPoint(R.clientX,R.clientY)?.closest(".aethercal-tg-col"),z=X?.dataset.date?X:y.currentCol;y.currentCol=z,y.currentDate=z.dataset.date??y.anchorDate,y.currentMinute=ae(Ee(R.clientY,z),v.config);let ne=fe({dateOnly:y.anchorDate,minuteOfDay:y.anchorMinute},{dateOnly:y.currentDate,minuteOfDay:y.currentMinute}),we=(y.currentDate===y.anchorDate?le([{id:"__sel",title:"",start:ne.start,end:ne.end}],y.anchorDate,v.config):[])[0];B(we?{dateOnly:y.anchorDate,topFraction:we.topFraction,heightFraction:we.heightFraction}:null)}},h=R=>{let y=D.current;D.current=null,P(null),B(null),R&&y&&(y.kind==="resize"&&y.payload&&d&&d(y.payload),y.kind==="select"&&c&&(y.currentDate!==y.anchorDate||y.currentMinute!==y.anchorMinute)&&c(fe({dateOnly:y.anchorDate,minuteOfDay:y.anchorMinute},{dateOnly:y.currentDate,minuteOfDay:y.currentMinute}))),S({type:R?"COMMIT":"CANCEL"})},p=R=>{D.current&&R.pointerId!==D.current.pointerId||h(!0)},I=R=>{D.current&&R.pointerId!==D.current.pointerId||h(!1)},G=R=>{R.key==="Escape"&&h(!1)};return window.addEventListener("pointermove",f),window.addEventListener("pointerup",p),window.addEventListener("pointercancel",I),window.addEventListener("keydown",G),()=>{window.removeEventListener("pointermove",f),window.removeEventListener("pointerup",p),window.removeEventListener("pointercancel",I),window.removeEventListener("keydown",G)}},[Te,a,v.config,d,c]);let L=w.useCallback((f,h)=>p=>{if(!u||p.target.closest("[data-event-id], button"))return;if(p.preventDefault(),!h){u({start:`${f}T00:00:00`});return}let I=ae(Ee(p.clientY,p.currentTarget),v.config),G=g(`${f}T00:00:00`),R=new Date(G.getFullYear(),G.getMonth(),G.getDate(),0,I,0);u({start:k(R)})},[u,v.config]),Me={"--ac-tg-cols":v.columns.length,"--ac-tg-hours":v.config.dayEndHour-v.config.dayStartHour};return oe("div",{className:be("aethercal-calendar","aethercal-timegrid",M&&"is-dragging",C.status==="resizing"&&"is-resizing",C.status==="selecting"&&"is-selecting"),role:"grid","aria-label":vt(n,r),"data-view":t,style:Me,children:[oe("div",{className:"aethercal-tg-head",role:"row",children:[A("div",{className:"aethercal-tg-corner"}),v.columns.map(f=>A("div",{role:"columnheader",className:be("aethercal-tg-colhead",f.dateOnly===T&&"is-today"),"data-date":f.dateOnly,children:A("span",{className:"aethercal-tg-colhead-date",children:ft(f.dateOnly,r)})},f.dateOnly))]}),oe("div",{className:"aethercal-tg-allday",role:"row",children:[A("div",{className:"aethercal-tg-rowhead",role:"rowheader",children:l}),v.columns.map(f=>A("div",{role:"gridcell",className:"aethercal-tg-allday-cell","data-date":f.dateOnly,onDragOver:W?h=>h.preventDefault():void 0,onDrop:W?U(f.dateOnly,!1):void 0,onContextMenu:u?L(f.dateOnly,!1):void 0,children:f.allDay.map(h=>A(he,{event:h,timeLabel:null,onDragStart:_,onDragEnd:K,isPending:E.has(h.id),isRolledBack:m.has(h.id),...b?{onClick:()=>b({id:h.id})}:{},...u?{onContextMenu:()=>u({id:h.id})}:{}},h.id))},f.dateOnly))]}),oe("div",{className:"aethercal-tg-body",role:"row",children:[A("div",{className:"aethercal-tg-gutter",role:"presentation","aria-hidden":"true",children:v.hourMarks.map(f=>A("div",{className:"aethercal-tg-hour",style:{top:Q(f.topFraction)},children:yt(f.hour,r)},f.hour))}),v.columns.map(f=>oe("div",{role:"gridcell",className:be("aethercal-tg-col",f.dateOnly===T&&"is-today"),"data-date":f.dateOnly,onDragOver:W?h=>h.preventDefault():void 0,onDrop:W?U(f.dateOnly,!0):void 0,onPointerDown:N?Re(f.dateOnly):void 0,onContextMenu:u?L(f.dateOnly,!0):void 0,children:[v.hourMarks.map(h=>A("div",{className:"aethercal-tg-line",style:{top:Q(h.topFraction)},"aria-hidden":"true"},h.hour)),x&&x.dateOnly===f.dateOnly?A("div",{className:"aethercal-tg-select-band",style:{top:Q(x.topFraction),height:Q(x.heightFraction)},"aria-hidden":"true"}):null,f.timed.map(h=>{let{event:p}=h,I=p.editable!==!1,G=re(p.start,r),R=O?.id===p.id?O:null,y=R?le([{...p,start:R.start,end:R.end}],f.dateOnly,v.config)[0]:void 0,X=y?y.topFraction:h.topFraction,z=y?y.heightFraction:h.heightFraction,ne={top:Q(X),height:Q(z),left:Q(h.lane/h.laneCount),width:Q(1/h.laneCount),...p.color?{"--ac-tg-event-accent":p.color}:{}};return oe("div",{className:be("aethercal-tg-event",!I&&"is-locked",E.has(p.id)&&"is-pending",m.has(p.id)&&"is-rolledback",!!R&&"is-resizing"),draggable:I,"data-event-id":p.id,"data-lane":h.lane,"data-lane-count":h.laneCount,"aria-label":`${G} ${p.title}`,title:p.title,style:ne,onDragStart:j=>{if(D.current?.kind==="resize"){j.preventDefault();return}j.dataTransfer.setData("text/plain",p.id),j.dataTransfer.effectAllowed="move",_(p.id)},onDragEnd:K,onClick:b?()=>b({id:p.id}):void 0,onContextMenu:u?j=>{j.preventDefault(),j.stopPropagation(),u({id:p.id})}:void 0,children:[A("time",{className:"aethercal-tg-event-time",children:G}),A("span",{className:"aethercal-tg-event-title",children:p.title}),Y&&I?oe(Gt,{children:[A("div",{className:"aethercal-tg-resize-handle aethercal-tg-resize-handle-start","data-edge":"start","aria-hidden":"true",draggable:!1,onPointerDown:J(p,"start")}),A("div",{className:"aethercal-tg-resize-handle aethercal-tg-resize-handle-end","data-edge":"end","aria-hidden":"true",draggable:!1,onPointerDown:J(p,"end")})]}):null]},p.id)}),$!==null&&f.dateOnly===T?A("div",{className:"aethercal-now-indicator",style:{top:Q($)},"aria-hidden":"true"}):null]},f.dateOnly))]})]})}import{jsx as De}from"react/jsx-runtime";function zt(e){return e instanceof Date?e:typeof e=="string"?g(e):new Date}function Ht(e){return e instanceof Date?e:typeof e=="string"?g(e):new Date}var $t=e=>`+${e} more`,Bt=e=>`ends ${e}`;function xe(e){let{view:t="month",events:n,anchor:a,locale:r="en",firstDayOfWeek:i=1,maxEventsPerDay:o=3,weekdayLabels:l,formatMore:s=$t,unavailableLabel:d="This view is not available yet.",dayStartHour:c,dayEndHour:b,allDayLabel:u="All day",now:E,continuesLabel:m="Continues",formatEndsLabel:v=Bt,agendaEmptyLabel:$="No events",onEventDrop:T,onEventResize:C,onRangeSelect:S,onEventClick:D,onContextMenu:O,pendingIds:P,rolledBackIds:x}=e;ee.useEffect(()=>{ce()},[]);let B=ee.useMemo(()=>zt(a),[a]),[W,Y]=ee.useState(()=>new Date);ee.useEffect(()=>{if(E!==void 0||t!=="week"&&t!=="day")return;let J=setInterval(()=>Y(new Date),6e4);return()=>clearInterval(J)},[E,t]);let N=ee.useMemo(()=>E!==void 0?Ht(E):W,[E,W]),M=Number.isInteger(i)&&i>=0&&i<=6?i:1,U=Number.isInteger(o)&&o>=0?o:3,_=l&&l.length===7?l:void 0,K=ee.useMemo(()=>({...c!==void 0?{dayStartHour:c}:{},...b!==void 0?{dayEndHour:b}:{}}),[c,b]);if(t==="list")return De(ot,{events:n??[],locale:r,allDayLabel:u,continuesLabel:m,formatEndsLabel:v,emptyLabel:$});if(t==="month")return De(ut,{events:n??[],anchor:B,locale:r,firstDayOfWeek:M,maxEventsPerDay:U,formatMore:s,..._?{weekdayLabels:_}:{},...T?{onEventDrop:T}:{},...D?{onEventClick:D}:{},...O?{onContextMenu:O}:{},...P?{pendingIds:P}:{},...x?{rolledBackIds:x}:{}});if(t==="week"||t==="day"){let J=t==="week"?Se(B,M):[V(k(B))];return De(We,{view:t,days:J,events:n??[],locale:r,config:K,now:N,allDayLabel:u,...T?{onEventDrop:T}:{},...C?{onEventResize:C}:{},...S?{onRangeSelect:S}:{},...D?{onEventClick:D}:{},...O?{onContextMenu:O}:{},...P?{pendingIds:P}:{},...x?{rolledBackIds:x}:{}})}return De("div",{className:"aethercal-calendar aethercal-unavailable",role:"status","data-view":t,children:d})}var Yt=xe;import*as F from"react";function Ut(){return typeof crypto<"u"&&typeof crypto.randomUUID=="function"?crypto.randomUUID():`cm-${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}var Vt=8e3,Wt=900;function Ke(e){let{events:t,mutate:n,timeoutMs:a=Vt,rollbackFlashMs:r=Wt,generateId:i=Ut}=e,[o,l]=F.useReducer(_e,Ne),s=F.useRef(t);s.current=t;let d=F.useRef(!0),c=F.useRef(new Map);F.useEffect(()=>{d.current=!0;let E=c.current;return()=>{d.current=!1;for(let m of E.values())clearTimeout(m);E.clear()}},[]),F.useEffect(()=>{for(let E of ze(t,o)){let m=o.overrides[E];l({type:"CLEAR",id:E,...m?{clientMutationId:m.clientMutationId}:{}})}},[t,o]);let b=F.useCallback((E,m)=>{let v=i(),$=s.current.find(x=>x.id===m.id),T=c.current,C=x=>{let B=T.get(x);B!==void 0&&(clearTimeout(B),T.delete(x))},S=()=>{T.set(`fl:${v}`,setTimeout(()=>{T.delete(`fl:${v}`),d.current&&l({type:"CLEAR",id:m.id,clientMutationId:v})},r))};l({type:"SUBMIT",id:m.id,clientMutationId:v,start:m.start,end:m.end,...$?.revision!==void 0?{baseRevision:$.revision}:{}}),T.set(`to:${v}`,setTimeout(()=>{T.delete(`to:${v}`),d.current&&(l({type:"TIMEOUT",id:m.id,clientMutationId:v}),S())},a));let D=()=>{C(`to:${v}`),d.current&&(l({type:"REJECT",id:m.id,clientMutationId:v}),S())},O={kind:E,clientMutationId:v,payload:{...m,client_mutation_id:v}},P;try{P=n(O)}catch(x){P=Promise.reject(x instanceof Error?x:new Error(String(x)))}P.then(x=>{if(x.id!==m.id){D();return}C(`to:${v}`),d.current&&l({type:"RESOLVE",id:x.id,clientMutationId:v,start:x.start,end:x.end,revision:x.revision})}).catch(D)},[n,a,r,i]),u=F.useMemo(()=>Ge(t,o),[t,o]);return{events:u.events,pendingIds:u.pendingIds,rolledBackIds:u.rolledBackIds,submit:b}}import{jsx as Jt}from"react/jsx-runtime";function Kt({events:e,mutate:t,timeoutMs:n,rollbackFlashMs:a,generateId:r,...i}){let{events:o,pendingIds:l,rolledBackIds:s,submit:d}=Ke({events:e,mutate:t,...n!==void 0?{timeoutMs:n}:{},...a!==void 0?{rollbackFlashMs:a}:{},...r?{generateId:r}:{}});return Jt(xe,{...i,events:o,pendingIds:l,rolledBackIds:s,onEventDrop:c=>d("drop",c),onEventResize:c=>d("resize",c)})}export{xe as AetherCalendar,pt as CALENDAR_CSS,Kt as OptimisticCalendar,bt as TIME_GRID_CSS,We as TimeGridView,Yt as default,ce as ensureCalendarStyles,Ve as ensureTimeGridStyles,Ke as useOptimisticEvents};

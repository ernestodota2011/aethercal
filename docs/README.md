...
| [CalDAV busy-check](caldav-busy-check.md) | Connect a **read-only** CalDAV calendar (Nextcloud, Radicale, iCloud…) as a second busy provider — breaking the Google monoculture (RNF-9) |
